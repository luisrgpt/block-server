...
public interface IFileSystemServer extends Remote {
	FileSystemServerReply storePubKey(EncodedCertificate certificate) throws RemoteException, InvalidRemoteArgumentException, CertificateException, KeyStoreException, NullArgumentException;
